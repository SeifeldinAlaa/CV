...
import ImgProfile from '../images/Seif.jpg';
...
<p> Web Developer</p>
                    ...
                    <div className='card-reveal'>
                        ...
                        <a href="https://github.com/SeifeldinAlaa">   <i class="fab fa-github" style={{'color':'black'}}></i></a>
                           ...
                           <a href="https://www.instagram.com/seif_kickboxingchampion/"> <i className='fab fa-instagram grey-text text-darken-4 social-style'></i></a>
